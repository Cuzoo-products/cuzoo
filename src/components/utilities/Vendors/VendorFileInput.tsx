...
export function VendorFileInput({
  ...
  return (
    <div className={cn("vendor-form-file-field w-full min-w-0", className)}>
      <input
        id={id}
        type="file"
        accept={accept}
      ...
      <label
        htmlFor={id}
        className="vendor-form-file-trigger flex w-full min-w-0 items-center gap-4 overflow-hidden"
      >
        <span className="vendor-form-file-button shrink-0">
          {isProcessing ? "Compressing…" : "Choose File"}
        </span>
        <span
          className="vendor-form-file-text min-w-0 flex-1 overflow-hidden text-ellipsis whitespace-nowrap"
