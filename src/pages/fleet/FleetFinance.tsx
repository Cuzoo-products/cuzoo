...
export default function FleetFinance() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="fleet-wallet-card">
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            to="/fleet/banks"
            className="rounded-lg bg-white px-6 py-2.5 text-sm font-medium text-[var(--fleet-sidebar-primary)] transition-colors hover:bg-white/90"
          >
            Manage Banks
          </Link>
          <WithdrawDialog
            ...
            contentClassName="fleet-portal-dialog"
          />
        </div>
